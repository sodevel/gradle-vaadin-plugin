...
class MessageLogger {
    ...
    static nagUserOfDiscontinuedProperty(String propertyName, String advice) {
        SingleMessageLogger.warnOfChangedBehaviour("The $propertyName property ${getDeprecationMessage()}. ", advice)
    }
    ...
    static nag(String advice) {
        SingleMessageLogger.warnOfChangedBehaviour(advice, null)
    }
}
